...
1. The Dockerfile's `MESA_VERSION` pin-check exists because a distro archive that regresses below 26.1 would silently halve B70 decode. CI tracks Mesa releases and rebuilds when they land.
